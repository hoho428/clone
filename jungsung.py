# st = """my life is  been magic  seems fantastic
...
# b = cnt.index(a)
# c = words[b]
# print("노래 가사 중에서 가장 많이 나온 단어는", c, "이고", a, "번 나왔습니다.")
# # a = cnt.index(max(cnt))
# # print(words[a])
...
# decryption = ""
# # print(li.index('z'))
# str = "Htwwjhy~ Z W xt Ljsnzx!! N lnaj Z uwjxjsy ktw ufxxnsl ymnx Vzjxy~ Gzy Dtz Mfaj Yt Xfd 'RTTDFMT' yt Rd Pfpft Yfqp Fhhtzsy. Mfmf~~"
# for j in str:
#     # print(j,"index 값은", li.index(j))
#     if j == "~" or j == " " or j == "!" or j =='\'' or j == '.':
#         print(j, end="")
        
#     elif li.index(j)-key < 0:
#         print(li[li.index(j)+len(li)-key], end="")
        
#     else:
#         print(li[li.index(j)-key], end="")
        
# # str = 'khoor'
# # for j in str:
# #     if li.index(j)-3 < 0:
# #         print(j, "해독된 값은", li[li.index(j)+len(li)-1])
# #     else:
# #         print(j, "해독된 값은", li[li.index(j)-3])
...
# xt Ljsnzx
# soxGenius
# print("번역 시작 합니다 번호 선택 하세요")
# print("1.카이사르 암호학을 영어로 변환, 2.영어를 카이사르 암호화하기")
# sel = int(input("번호 입력 : "))
# st = input("문장 입력 : ")
# a = st.split()
# print(a)
...
#         li.append(chr(j))
#     for k in st: #첫번째 바퀴:k = Z 출력U 두번째바퀴:K = " " 출력" "
#         li.append(k) 
#         if k == " " :
#             print(end = "")
#         key = li.index(k)-5 #두번째바퀴:공백이있는 인덱스 - 5를 해줌 

#         print(li[key],end="")  # 두번째바퀴:공백이있는 인덱스 -5 값 출력
...
# # # # 7-1 숫자하나를 입력값으로 하고 해당숫자안의 홀수의 개수를 반환해주는 함수


# def 홀개(N):
#     su = 0
#     for i in str(42601): #"N"
#         if int() % 2 == 1: 
#             su += 1
#     return su
...
# 첫번째
# li = 42601 홀개(42601) - > retrun su - > 1   len(str(42601)) -> 5  1 == 5 같지 않아
# print() 안함
